    ...
    <div style={{ padding: '20px', maxWidth: '800px', margin: 'auto', border: '1px solid #ddd', borderRadius: '10px' }}>
      <div style={{ display: 'flex', marginBottom: '20px' }}>
        <div style={{ flex: '1', marginRight: '20px' }}>
          <img src={productDetails?.images || "https://via.placeholder.com/400"} alt="Product" style={{ width: '100%', borderRadius: '10px' }} />
        </div>
        <div style={{ flex: '2' }}>
      ...
      <div>
        ...
        <img src="https://via.placeholder.com/200" alt="Description Image" style={{ width: '100%', borderRadius: '10px', marginTop: '10px' }} />
      </div>
    </div>
  );
};
